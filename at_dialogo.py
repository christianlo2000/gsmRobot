################################################################
# Script....: at_dialogo.py
# Objetivo..: Permite configurar a traves de comandos AT Modem USB
...
# definimos clases para capturar teclas del teclado
class _Getch:
    """
...
c = ""
try:
	# abro conexion serie con el modem usb 3g o 4g
	ser = serial.Serial('/dev/ttyUSB0', 460800, timeout=1)
	# inicializamos lista para guardar comandos
	listCom = []
	print("Bienvenido, si quiere finalizar el programa, ingrese la palabra quit y pulse <enter>")
	while(True):
		# dialogo con el modem por comandos AT
		comando = raw_input("Ingrese comando AT-> ")
		if (comando == "quit"):
		...
		print(retorno)
		time.sleep(.5)
		# guardamos en lista ultimo comando ingresado
		listCom.append(comando) 
except KeyboardInterrupt:
	print("Se ha interrumpido el script por teclado")
	ser.close()
finally:
	ser.close()
